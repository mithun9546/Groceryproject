...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="login.jsp">Grocerry Shopping</a>
    </div>
    <ul class="nav navbar-nav">
      <li class="active"><a href="#">Home</a></li>
...
<div class="container">
            <form:form class="form-horizontal" role="form"  method="POST" action="/calculateCost" modelAttribute="ticket" >
                <h2>Registration</h2>
				 ...
				 <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-4">
                                <sf:label class="radio-inline" path="gender">
